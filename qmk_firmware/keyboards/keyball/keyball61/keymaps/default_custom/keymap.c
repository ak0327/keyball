...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_universal(
    ...
    KC_LSHT  , KC_Z     , KC_X     , KC_C     , KC_V     , KC_B     , KC_LBRC  ,              KC_RBRC, KC_N     , KC_M     , KC_COMM  , KC_DOT   , KC_SLSH  , MO(3)    ,
    MO(3)    , _______  , KC_LALT  , KC_LGUI  ,LT(1,KC_LNG2),KC_SPC , MO(3)    ,              KC_ENT ,LT(2,LNG1), _______  , _______  , _______  , KC_BSLS  , KC_GRV
  ),
  ...
  [2] = LAYOUT_universal(
    ...
    _______  , _______  , _______  , _______  , _______  , _______  , _______  ,            _______  , LSG(KC_T),LCS(KC_TAB),LGUI(KC_T),LCTL(KC_TAB), _______  , _______  ,
    _______  , _______  , _______  , _______  , _______  , _______  , _______  ,            _______  , _______  , _______  , _______  , _______  , _______  , _______
  ),

  [3] = LAYOUT_universal(
   _______  , _______  , _______  , _______  , _______  , _______  ,                                  _______  , _______  , _______  , _______  ,LCTL(KC_DOWN),LCTL(KC_UP),
